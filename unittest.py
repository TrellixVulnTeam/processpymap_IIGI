...
Protocite_Bar_B = Node('Protocite Bar',Quantum_Processor,277,1,2)
Protocite_Ore_B = Node('Protocite Ore',Protocite_Bar_B,2,1,2) 
...
printresultedamount(Quantum_Processor)
"""terminating process"""
